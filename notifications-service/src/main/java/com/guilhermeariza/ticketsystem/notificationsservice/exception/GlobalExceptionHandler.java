package com.guilhermeariza.ticketsystem.notificationsservice.exception;
...
/**
 * This service has no REST controllers today (it only consumes RabbitMQ events), so this
 * advice is currently inert. Kept for consistency with the other services and to be ready
 * if/when a REST API is added here.
 */
